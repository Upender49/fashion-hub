    ...
    return list
      ...
      <div class="product-card" data-id="${p.id}">
        <div class="product-img">
          ${p.image_url ? `<img src="http://localhost:5000${p.image_url}" style="width:100%;height:100%;object-fit:cover;border-radius:var(--radius) var(--radius) 0 0;" alt="${p.name}">` : p.emoji}
        </div>
